...
const ENGINES = new Map<string, ScoringEngine>([
  ...
  [v6.SCORING_VERSION, { version: v6.SCORING_VERSION, scoreTeam: v6.scoreTeam }],
]);

/**
 * Version utilisée pour les **nouveaux** chapitres.
 *
 * Le v1 au v5 restent enregistrés, et ce n'est pas de la politesse : les
 ...
 */
export const CURRENT_SCORING_VERSION = v6.SCORING_VERSION;
